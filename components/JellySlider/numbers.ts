...
export class NumberProvider {
    ...
    async fillAtlas() {
        ...
        // Note: In a real app, you might want to handle font loading more robustly
        // or ensure these fonts are available in your global CSS.
        try {
            await Promise.all([
            ...
            console.warn("Fonts failed to load, using fallbacks", e);
        }
